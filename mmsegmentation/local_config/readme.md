...
- 1.Download the dataset mentioned in [README.md](https://github.com/dashen2004/Edge-Enhanced-Dual-Stream-Transformer-for-Small-Polyp-Segmentation/blob/main/README.md), then decompress the dataset.
